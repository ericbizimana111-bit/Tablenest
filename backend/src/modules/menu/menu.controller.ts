...
export class MenuController {
  ...
  @UseGuards(AuthGuard('jwt'))
  @Put('categories/:id')
  updateCategory(@Param('id', MongoIdValidationPipe) id: string, @Body() data: any) {
    return this.menuService.updateCategory(id, data);
  }

  @UseGuards(AuthGuard('jwt'))
  @Delete('categories/:id')
  deleteCategory(@Param('id', MongoIdValidationPipe) id: string) {
  ...
  @UseGuards(AuthGuard('jwt'))
  @Put('items/:id')
  updateItem(@Param('id', MongoIdValidationPipe) id: string, @Body() data: any) {
    return this.menuService.updateItem(id, data);
  }

  @UseGuards(AuthGuard('jwt'))
  @Patch('items/:id/toggle')
  toggleAvailability(@Param('id', MongoIdValidationPipe) id: string) {
