        ...
        <div className="fade-in">
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 24 }}>
                <div>
                    ...
                    <p style={{ fontSize: 13, color: '#475569' }}>Track stock levels and manage suppliers.</p>
                </div>
            ...
            {lowStock.length > 0 && (
                <div style={{ background: '#FEF3C7', border: '1px solid #F59E0B', borderRadius: 10, padding: '12px 16px', marginBottom: 18, display: 'flex', alignItems: 'center', gap: 10 }}>
                        ...
                        {allItems.map((item: InventoryItem) => {
                            ...
                            return (
                                <tr key={item._id}>
                                    ...
                                    <td style={{ fontSize: 13, color: '#475569' }}>{item.unit}</td>
                                    <td>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                                            <span style={{ fontSize: 13, fontWeight: 600, color: isLow ? '#DC2626' : '#0F172A' }}>{item.quantity}</span>
                                            {isLow && <AlertTriangle size={13} color="#DC2626" />}
                                        </div>
                                    </td>
                                    <td style={{ fontSize: 13, color: '#475569' }}>{item.minQuantity}</td>
                                    <td style={{ fontSize: 13, color: '#475569' }}>{item.supplier || '—'}</td>
