    ...
    return (
        <div style={{ fontFamily: 'Poppins, sans-serif', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
            ...
            <footer style={{ background: '#1F1F1F', padding: '32px 80px', display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 32 }}>
                ...
                {[['Quick Links', ['Browse Restaurants', 'Table Specials', 'Gift Cards']], ['For Restaurants', ['List Your Venue', 'Partner Dashboard', 'Resources']], ['Contact Info', ['support@tablenest.com', '1-800-NEST-RES']]].map(([title, items]: [string, string[]]) => (
                    <div key={title}>
