            ...
            <div style={{
                ...
                <div style={{ width: '100%', maxWidth: 380, position: 'relative', zIndex: 1 }}>
                    ...
                    <div style={{ marginBottom: 36 }}>
                        <h1 style={{ fontSize: 30, fontWeight: 800, color: '#FFFFFF', marginBottom: 8, letterSpacing: '-0.5px' }}>
                            Welcome Back
                        </h1>
                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                        ...
                        <div>
                            ...
                            <div style={{ position: 'relative' }}>
                                <Mail size={18} style={{
                                    ...
                                    color: focusedField === 'email' ? '#F97316' : 'rgba(255,255,255,0.3)',
                            ...
                            {errors.email && <span style={{ fontSize: 12, color: '#FCA5A5', marginTop: 4, display: 'block' }}>{errors.email}</span>}
                        </div>
                        ...
                        <div>
                            ...
                            <div style={{ position: 'relative' }}>
                                <Lock size={18} style={{
                                    position: 'absolute', left: 14, top: '50%', transform: 'translateY(-50%)',
                                    color: focusedField === 'password' ? '#F97316' : 'rgba(255,255,255,0.3)',
                                    transition: 'color 0.2s',
                                }} />
                                <input
                        ...
                        <label style={{ display: 'flex', alignItems: 'center', gap: 10, cursor: 'pointer', userSelect: 'none' }}>
                            <div
                                ...
                                style={{
                                    ...
                                    borderColor: rememberMe ? '#F97316' : 'rgba(255,255,255,0.2)',
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 16, margin: '4px 0' }}>
                            ...
                            <span style={{ fontSize: 12, color: 'rgba(255,255,255,0.3)', fontWeight: 500 }}>or continue with</span>
                            <div style={{ flex: 1, height: 1, background: 'rgba(255,255,255,0.08)' }} />
                        </div>
                        ...
                        {/* Sign up link */}
                        <p style={{ textAlign: 'center', fontSize: 14, color: 'rgba(255,255,255,0.45)', margin: '8px 0 0' }}>
